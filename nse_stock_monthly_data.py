...
for symbol in stock_symbol['d__002']:
    ...
    print(symbol)
    data_monthly = tv.get_hist(symbol,'NSE',interval=Interval.in_monthly,n_bars=10000) # Download Data
    data_monthly.drop(['symbol'], axis = 1) # drop symbol column
    data_monthly.to_csv('Datafeed/' + symbol + '_monthly.csv') # Store into csv file
