...
for symbol in stock_symbol['d__002']:
    ...
    print(symbol)
    data_1_minute = tv.get_hist(symbol,'NSE',interval=Interval.in_1_minute,n_bars=10000) # Download Data
    data_1_minute.drop(['symbol'], axis = 1) # drop symbol column
    data_1_minute.to_csv('Datafeed/' + symbol + '_1_minute.csv') # Store into csv file
