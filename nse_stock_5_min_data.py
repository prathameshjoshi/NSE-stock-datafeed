...
for symbol in stock_symbol['d__002']:
    ...
    print(symbol)
    data_5_minute = tv.get_hist(symbol,'NSE',interval=Interval.in_5_minute,n_bars=10000) # Download Data
    data_5_minute.drop(['symbol'], axis = 1) # drop symbol column
    data_5_minute.to_csv('Datafeed/' + symbol + '_5_minute.csv') # Store into csv file
