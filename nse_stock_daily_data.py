...
for symbol in stock_symbol['d__002']:
    ...
    print(symbol)
    data_daily = tv.get_hist(symbol,'NSE',interval=Interval.in_daily,n_bars=10000) # Download Data
    data_daily.drop(['symbol'], axis = 1) # drop symbol column
    data_daily.to_csv('Datafeed/' + symbol + '_daily.csv') # Store into csv file
