...
for symbol in stock_symbol['d__002']:
    ...
    print(symbol)
    data_4_hour = tv.get_hist(symbol,'NSE',interval=Interval.in_4_hour,n_bars=10000) # Download Data
    data_4_hour.drop(['symbol'], axis = 1) # drop symbol column
    data_4_hour.to_csv('Datafeed/' + symbol + '_4_hour.csv') # Store into csv file
