...
for symbol in stock_symbol['d__002']:
    ...
    print(symbol)
    data_3_hour = tv.get_hist(symbol,'NSE',interval=Interval.in_3_hour,n_bars=10000) # Download Data
    data_3_hour.drop(['symbol'], axis = 1) # drop symbol column
    data_3_hour.to_csv('Datafeed/' + symbol + '_3_hour.csv') # Store into csv file
